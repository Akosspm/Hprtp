...
def start(message):
    ...
    bot.send_video(
        message.chat.id,
        caption="🤖 Bot Status: Active ✅ Join <a href=\"t.me/amiroux_ff\">Here</a> to Get Updates And Keys For The Bot. By <a href=\"t.me/nkmok\">SMS EXE</a> If You Want to Run a Bot In Your Group, Make Sure The Bot is The Admin 🎁",
...
def cmds_callback(call):
    ...
    keyboard.add(
        ...
        types.InlineKeyboardButton("𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑", url="https://t.me/amiroux_ff")
    )
